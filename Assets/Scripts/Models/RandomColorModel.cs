...
public partial class RandomColorModel : RealtimeModel {
    ...
    public delegate void PropertyChangedHandler<in T>(RandomColorModel model, T value);
    ...
    public RandomColorModel() : base(null) {
